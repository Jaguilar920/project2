    ...
    render() {
        ...
        return (
            ...
            <div className="container">
                ...
                <form
                    action={`/dnd/edit/${_id}?_method=put`}
                    method="POST"
                >
                    ...
                    <input type="file" className="form-control-file" name="image" value={img} id="exampleFormControlFile1"/>

                    <label className="mt-3">Race:</label>
                    <select className="custom-select" name="race" value={race}>
                    ...
                    <label className="mt-3">Race:</label>
                    <select className="custom-select" name="tree" value={tree}>
                    <option selected>Choose Race...</option>
                    ...
                    <select className="custom-select" name="alignment" value={alignment}>
                    ...
                    <select className="custom-select levelSel" value={level} name="level">
